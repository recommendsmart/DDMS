...
/**
 * Notesheets autocomplete controller.
 */
class NotesheetsAutocompleteController extends ControllerBase {
  ...
  /**
   * Constructs a NotesheetsAutocompleteController object.
   *
  ...
  public function autocomplete(Request $request) {
    ...
    $selection_settings = [
      'view' =>
        [
          'view_name' => 'notesheets',
          'display_name' => 'notesheets_autocomplete_entity_reference',
          'arguments' =>
            [],
        ],
    ...
    foreach ($entity_labels as $values) {
      foreach ($values as $entity_id => $label) {
        $node_url = Url::fromRoute('entity.node.canonical', ['node' => $entity_id], ['query' => ['suggested-notesheet' => TRUE]])->toString();
